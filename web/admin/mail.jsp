                            ...
                            <div class="panel-body">
                                ...
                                <ul class="nav nav-pills nav-stacked mail-nav">
                                    ...
                                    <li><a href="#"> <i class="fa fa-file-text-o"></i> Drafts <span
                                            class="label label-info pull-right inbox-notification">123</span></a></a>
                                    </li>
                                ...
                                <div class="table-inbox-wrap ">
                                    <table class="table table-inbox table-hover">
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="view-message"><a href="#">Dolor sit amet, consectetuer
                                                adipiscing</a></td>
                                            <td class="view-message inbox-small-cells"></td>
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="view-message view-message">Dolor sit amet, consectetuer
                                                adipiscing
                                            </td>
                                            <td class="view-message inbox-small-cells"></td>
